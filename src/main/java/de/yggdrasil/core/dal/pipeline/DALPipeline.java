 ...
 * or writing data from or to a data source.
 *
 * The annotation is meant to be used in combination with the Pipeline interface.
 *
 * The ClassCollector interface can be used to collect all classes annotated with DALPipeline
 ...
 *
 * // Class implementing Pipeline interface but annotated with HideFromDefaultClassCollector
 * @DALPipeline
